...
class __TwigTemplate_b92258a4ca3984cb05b920972c7721491c4090eb2a9e9b3d53eba58ae867d678 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  115 => 28,  106 => 22,  99 => 19,  91 => 16,  88 => 15,  86 => 14,  83 => 13,  77 => 11,  75 => 10,  68 => 5,  58 => 4,  35 => 1,);
    }
...
{% block body %}
    ...
    {% endif %}
                <form action=\"{{ path('signup_administrateur') }}\" method=\"POST\">
                    <div class=\"form_input\">
                        <p>Votre identifiant</p>
                        <input type=\"text\" required placeholder=\"contact@mondomaine.com\" value=\"{{ last_username }}\" name=\"email\" />
                    </div>
                    <div class=\"form_input\">
                        <p>Votre mot de passe</p> 
                        <input type=\"password\" required placeholder=\"••••••••\" name=\"password\" />
