...
class __TwigTemplate_6fc34447c45cd6775d1d83476ffe2bb626a65258f84f26634e9532ecc0591175 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["administrator"]) {
            ...
            if ((twig_get_attribute($this->env, $this->source, $context["administrator"], "visible", [], "any", false, false, false, 27) == true)) {
                ...
                echo "</td>
                                    <td>";
                // line 37
                echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatDateTime($this->env, twig_get_attribute($this->env, $this->source, $context["administrator"], "creationDate", [], "any", false, false, false, 37), "short", "none", "", null, "gregorian", "fr"), "html", null, true);
                echo "</td>
                        ...
                        <table cellSpacing=\"0\" cellPadding=\"0\">
                            ...
                            {% for administrator in administrators %}
                                ...
                                <tr>
                                    ...
                                    <td>{{ administrator.creationDate|format_datetime('short', 'none', locale='fr') }}</td>
